            ...
            <div>
              ...
              <div className="bg-surface-container-low rounded-xl p-5 border border-dashed border-outline-variant text-center">
                ...
                <div className="flex gap-2">
                  ...
                  <Link to="/leader/mom-detail" className="flex-1 py-2 text-xs font-semibold bg-on-surface text-white rounded-lg hover:opacity-80 transition-all text-center">Open MOM</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'transcript' && (
        <div className="ts-card p-8 max-w-3xl">
          ...
          <div className="space-y-6 font-mono text-sm text-on-surface-variant leading-relaxed">
            ...
            <div className="flex gap-4"><span className="text-outline w-16 flex-shrink-0">10:34</span><p><strong className="text-on-surface">David Chen:</strong> From a design perspective, the onboarding flow is our highest impact item.</p></div>
            <div className="flex gap-4"><span className="text-outline w-16 flex-shrink-0">10:38</span><p><strong className="text-on-surface">Jane Doe:</strong> Agreed. The auth refactor needs to happen first — it's blocking the mobile team.</p></div>
            <div className="flex gap-4"><span className="text-outline w-16 flex-shrink-0">10:45</span><p><strong className="text-on-surface">Marcus V.:</strong> QA is ready to run the security audit in parallel with the refactor...</p></div>
          </div>
        </div>
      )}
    </>
