...
export default function AdminMeetingDetail() {
  ...
  useEffect(() => {
    ...
    apiFetch(`/admin/meetings/${meetingId}`)
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-10">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <span className="badge-scheduled text-[10px]"><span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse"></span>{meeting.processingStage || 'initialized'}</span>
        ...
        {/* momId → navigation to MOM detail page */}
        {momId && (
          <Link to={`/admin/mom-detail?id=${momId}`} className="btn-secondary gap-2 flex-shrink-0">
